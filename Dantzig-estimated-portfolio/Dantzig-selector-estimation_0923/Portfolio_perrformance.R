...
setwd("~/Documents/Code/Network structure based portfolio/Dantzig-selector estimation covariance/Dantzig-selector_estimation_0922")
...
SharpeRatio(return_network_1constraint)
...
SharpeRatio(return_network_1constraint_noshort)
...
# glasso
SharpeRatio(return_minVar_glasso)
SharpeRatio(return_meanVar_glasso)
SharpeRatio(return_network_vary_with_phi_glasso[[1]])
SharpeRatio(return_network_1constraint_glasso)
SharpeRatio(return_network_vary_with_phi_glasso[[9]])
SharpeRatio(return_network_vary_with_phi_2constraint_glasso[[1]])
SharpeRatio(return_network_2constraint_glasso)
SharpeRatio(return_network_vary_with_phi_2constraint_glasso[[9]])
