# In this file, we modify network constraint portfolio with phi*=mean(EC_in[[t]]). Before, it was fixed as 0.8.

rm(list = ls())

setwd("~/Documents/Code/Network structure based portfolio/Dantzig-selector estimation covariance/Dantzig-selector_estimation_0923")
...
save(Portfolio.Scenario,file="Portfolios_0923.RData")
#### load data #####
